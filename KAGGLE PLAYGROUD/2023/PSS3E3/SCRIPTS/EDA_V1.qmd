...
- Al contrastar con la base de datos original se corrobora que este atípico está fuera del rango y debería ser eliminado.
...
- Se observa un valor atípico fuera del rango de referencia (7) se eliminará este registro.
...
```{r}
dataset_p %>% 
  skimr::skim(variables_numericas)
```
