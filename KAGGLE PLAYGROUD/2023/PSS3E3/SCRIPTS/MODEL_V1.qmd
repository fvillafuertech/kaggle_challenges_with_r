...
submit_sample %>% 
  ...
  write_csv("OUTPUTS/SUBMIT_V1.1_rf.csv", quote = "none")
...
submit_sample %>% 
  ...
  write_csv("OUTPUTS/SUBMIT_V1_xgb.csv", quote = "none")
...
submit_sample %>% 
  ...
  write_csv("OUTPUTS/SUBMIT_V1.csv", quote = "none")
